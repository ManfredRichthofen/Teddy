    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-purple-100">
      <div className="container mx-auto px-4 py-32">
        <div className="relative max-w-md mx-auto">
          {/* Floating Teddy positioned relative to this container */}
          <div 
            className="absolute -top-10 left-1/2 transform -translate-x-1/2 text-8xl cursor-pointer hover:scale-110 transition-transform duration-200 animate-[bounce_3s_ease-in-out_infinite] z-10"
